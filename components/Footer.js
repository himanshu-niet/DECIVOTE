...
const Footer = ({ footerData }) => {
  ...
  const { truckImg, hillImg, text, logo, links, form, boyImg } = footerData;
  return (
    <footer className="bg-darkblue lg:bg-transparent lg:bg-footer lg:bg-no-repeat lg:bg-left-bottom relative lg:min-h-[738px] pt-12 lg:pt-0">
      ...
      >
        ...
        >
          <Image src={truckImg} width={403} height={495} />
        </motion.div>
        {/* hill image */}
        ...
        >
          ...
          <div className="mb-6 mx-auto lg:mb-0 lg:mx-0">
            <Link href={"/"}>
              <h1 className={`text-3xl ml-2 font-semibold text-white`}>
                DeciVote
              </h1>
            </Link>
          </div>
